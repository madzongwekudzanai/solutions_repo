...
\[
\psi(x, y, t) = \sum\_{i=1}^{n} A \sin(k r_i - \omega t + \phi)
\]
...
We place the point sources at the vertices of a regular pentagon inscribed in a circle with the center at the origin \( (0, 0) \). The radius of the circle is \( r\_{\text{source}} = 5 \) meters.
...
\[
\psi(x, y, t) = \sum\_{i=1}^{5} A \sin(k r_i - \omega t + \phi)
\]
...
| \( S_2 \)        | \( \left(-\frac{5}{2}, \frac{5\sqrt{3}}{2}\right) \)  | \( \sqrt{(1 + \frac{5}{2})^2 + (1 - \frac{5\sqrt{3}}{2})^2} \) |
| \( S_3 \)        | \( (-5, 0) \)                                         | \( \sqrt{(1 + 5)^2 + (1 - 0)^2} = \sqrt{36 + 1} = \sqrt{37} \) |
| \( S_4 \)        | \( \left(-\frac{5}{2}, -\frac{5\sqrt{3}}{2}\right) \) | \( \sqrt{(1 + \frac{5}{2})^2 + (1 + \frac{5\sqrt{3}}{2})^2} \) |
...
By adjusting parameters such as frequency, amplitude, and the number of sources, we can further explore the complex behaviors of waves in two-dimensional spaces.
